...
public class C01_ReusableMethodsSwitchingWindow {
    ...
    public void test01() throws InterruptedException {
        ...
        // mesaji failde olunca veriyor.
        String ilkSayfaWHD = Driver.getDriver().getWindowHandle();

        //● Sayfa başlığının(title) “The Internet” olduğunu doğrulayın.
        String expectedTitle = "The Internet";
        String actualTitle = Driver.getDriver().getTitle();
        softAssert.assertEquals(actualTitle, expectedTitle, "sayfa title'i The Internet degil");
        ...
        ReusableMethods.switchToWindow("New Window"); // driverimiz yeni window a gecmedi.kendimiz gecirdik.
